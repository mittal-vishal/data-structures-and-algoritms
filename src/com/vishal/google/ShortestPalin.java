...
public class ShortestPalin {
    ...
    public static String shortestPalindrome(String s) {
        int suffixLen = createPrefixSuffixTable(s); //abcd dcba
        String strToAppend = new StringBuilder(s).reverse().substring(0, s.length() - suffixLen);
        String ans = new StringBuilder(strToAppend).append(s).toString();
        return ans;
    }

    private static int createPrefixSuffixTable(String s){
